...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 29, 2015 at 08:43 PM
...
CREATE TABLE IF NOT EXISTS `booking` (
  ...
  `drop_add` varchar(255) DEFAULT NULL,
...
INSERT INTO `booking` (`id`, `type_id`, `vendor_id`, `user_id`, `status`, `problem_id`, `slot_id`, `feedback`, `rating`, `pickup_add`, `drop_add`, `vehicle_id`) VALUES
(803109, 1, 654869, 807256, 'Pending', 1, 693730, NULL, NULL, 'wsws', 'sws', 602977);
...
(693730, '1200-1300', 1, 10, '2015-10-30T18:52:11.625Z', 654869),
...
--
ALTER TABLE `address`
  ADD PRIMARY KEY (`id`), ADD KEY `address_vendor_id_fk` (`vendor_id`), ADD KEY `address_user_id_fk` (`user_id`);
...
--
ALTER TABLE `booking`
  ADD PRIMARY KEY (`id`), ADD KEY `booking_slot_id_fk` (`slot_id`), ADD KEY `booking_problem_id_fk` (`problem_id`), ADD KEY `booking_user_id_fk` (`user_id`), ADD KEY `booking_vendor_id_fk` (`vendor_id`), ADD KEY `booking_type_id_fk` (`type_id`), ADD KEY `vehicle_id` (`vehicle_id`);
...
ALTER TABLE `booking_type_vendor`
  ADD PRIMARY KEY (`id`), ADD KEY `booking_type_vendor_vendor_id_fk` (`vendor_id`), ADD KEY `booking_type_vendor_booking_type_id_fk` (`type_id`);
...
ALTER TABLE `problem_vendor`
  ADD PRIMARY KEY (`id`), ADD KEY `problem_vendor_problem_id_fk` (`problem_id`), ADD KEY `problem_vendor_vendor_id_fk` (`vendor_id`);

--
-- Indexes for table `slot`
--
ALTER TABLE `slot`
  ADD PRIMARY KEY (`id`), ADD KEY `slot_vendor_id_fk` (`vendor_id`);
...
ALTER TABLE `user_vehicle`
  ADD PRIMARY KEY (`id`), ADD KEY `user_vehicle_vehicle_id_fk` (`vehicle_id`), ADD KEY `user_vehicle_user_id_fk` (`user_id`);
...
--
ALTER TABLE `booking`
ADD CONSTRAINT `booking_ibfk_1` FOREIGN KEY (`vehicle_id`) REFERENCES `vehicle` (`id`),
...
ADD CONSTRAINT `fk_booking_vehicle` FOREIGN KEY (`vehicle_id`) REFERENCES `vehicle` (`id`);
